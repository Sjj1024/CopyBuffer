<template>
    <div id="__next">
        <div class="open">
            <header class="Nav_header__CIQ1w">
                <nav
                    class="max-inline-size-container-wide Nav_nav__W3s5_"
                    aria-labelledby="topNavigationLabel"
                >
                    <p class="visually-hidden" id="topNavigationLabel">
                        Top navigation
                    </p>
                    <div class="Nav_content__6PY3c">
                        <div class="Nav_contentLeading__sZSG9">
                            <a class="Nav_logoLink__xSVf_" href="/">
                                ...
                                >
                                    <path
                                        d="M1 9.34 15.17 2l14.322 7.34-14.322 7.366L1 9.34ZM86.068 12.909v-.175c0-2.421 1.425-3.195 3.823-3.02V5.294c-5.746-.35-8.47 2.521-8.47 7.439v.175h-2.598v4.418h3.598v13.38h4.647v-13.38h5.346v13.38h4.647v-13.38h3.823v-4.418h-3.823v-.175c0-2.421 1.4-3.195 3.823-3.02V5.294c-5.746-.35-8.47 2.521-8.47 7.439v.175h-5.346Z"
                                    ></path>
                                    <path
                                        fill-rule="evenodd"
                                    ...
                                    ></path>
                                    <path
                                        d="M71.451 12.883v9.61c0 3.096-1.698 4.419-3.972 4.419-2.099 0-3.573-1.248-3.573-3.67V12.883H59.26v10.933c0 4.743 2.973 7.364 6.82 7.364 2.424 0 4.298-.898 5.348-2.496v1.997h4.647V12.883H71.45Z"
                                    ></path>
                                    <path
                                        fill-rule="evenodd"
                                    ...
                                    ></path>
                                    <path
                                        d="M126.044 15.954v-3.07h-4.648v17.798h4.648V22.17c0-3.745 3.048-4.818 5.471-4.519v-5.117c-2.273 0-4.547.999-5.471 3.42ZM15.17 29.301 5.503 24.06 1 26.493l14.17 7.676 14.322-7.676-4.553-2.434-9.77 5.242Z"
                                    ></path>
                                    <path
                                        d="m5.503 15.787 9.667 4.754 9.769-4.754 4.553 2.218-14.322 6.973L1 18.005l4.503-2.218Z"
                                    ></path>
                                </svg>
                            </a>
                        </div>
                        <div class="Nav_contentMiddle__NEWMQ">
                            <div
                                class="NavigationMenu_menu__05DPv"
                                data-position="start"
                                data-size="default"
                            >
                                <button
                                    class="NavigationMenu_trigger__tEQeR"
                                    type="button"
                                ...
                                >
                                    <span> Features </span>
                                    <svg
                                        class="NavigationMenu_triggerIcon__5Gtv5"
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                        aria-hidden="true"
                                ...
                                <div
                                    class="NavigationMenu_content__lo8BS"
                                    id="navigation-menu"
                                    role="dialog"
                                    data-state="closed"
                                >
                                    ...
                                    >
                                        <li>
                                            ...
                                            >
                                                ...
                                                >
                                                    <span
                                                        class="Nav_menuItemTextLeading__bdmiY"
                                                    >
                                                        <span
                                                            class="text-heading Nav_menuItemTitle__gsQC9"
                                                        >
                                                            Create
                                                        </span>
                                                        <svg
                                                    ...
                                                    <span
                                                        class="Nav_menuItemDescription___2r1C"
                                                    >
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M15.069 13.519v1.55l.775.775m-8.139-1.938L4.217 15.07l1.836-5.426-1.836-5.426 8.526 3.488m-6.2 1.938h3.875m9.302 5.426a4.65 4.65 0 1 1-9.302 0 4.65 4.65 0 0 1 9.302 0Z"
                                                    ></path>
                                                </svg>
                                                <span
                                                    class="Nav_menuItemText__B1O7e"
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M19.72 8.093 13.13 14.68l-3.876-3.875-5.038 5.038M19.72 8.093h-4.651m4.65 0v4.65"
                                                    ></path>
                                                </svg>
                                                <span
                                                    class="Nav_menuItemText__B1O7e"
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M14.914 9.798a1.938 1.938 0 0 0-2.713 0l-.233.31-.271-.232a1.876 1.876 0 1 0-2.48 2.79l2.79 2.713 2.79-2.713c.93-.93.853-2.093.156-2.868M8.79 18.17a6.976 6.976 0 1 0-3.023-3.023l-1.55 4.573 4.573-1.55Z"
                                                    ></path>
                                                </svg>
                                                <span
                                                    class="Nav_menuItemText__B1O7e"
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="m11.04 15.742 1.55 1.55a1.644 1.644 0 0 0 2.325-2.325m-1.55-1.55 1.938 1.937a1.644 1.644 0 1 0 2.325-2.325L14.62 10.02a2.326 2.326 0 0 0-3.286 0l-.682.682a1.644 1.644 0 0 1-2.326-2.325l2.178-2.179a4.488 4.488 0 0 1 5.473-.674l.364.217c.33.2.723.268 1.101.194l1.349-.272m0-.775.775 8.527h-1.55M4.838 4.89l-.776 8.527 5.04 5.039a1.644 1.644 0 1 0 2.325-2.325M4.837 5.664h6.202"
                                                    ></path>
                                                </svg>
                                                <span
                                                    class="Nav_menuItemText__B1O7e"
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M10.418 12.744a3.877 3.877 0 0 0 5.845.418l2.325-2.325a3.876 3.876 0 0 0-5.48-5.48l-1.333 1.325m1.744 4.511a3.876 3.876 0 0 0-5.845-.418L5.35 13.1a3.876 3.876 0 0 0 5.48 5.48l1.325-1.325"
                                                    ></path>
                                                </svg>
                                                <span
                                                    class="Nav_menuItemText__B1O7e"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ul
                                        class="Nav_channels__uyURn"
                                        aria-labelledby="channelsLabel"
                                    >
                                        <li>
                                            <a
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="Nav_channelLinkText__X3PBu"
                                                >
                                                    <span> Bluesky </span>
                                                    <svg
                                                        class="Nav_channelLinkIcon__YZ86q"
                                                        width="24"
                                                        height="24"
                                                        viewBox="0 0 24 24"
                                                        aria-hidden="true"
            ...
            <main
                style="
                    ...
                    overflow-x: clip;
                "
                class="jsx-1876722636"
            >
                <div class="container">
                    <div class="open_hero__QJjZp">
                        <h1 class="visually-hidden">Open metrics</h1>
                        <svg
                            class="open_heroLogoBufferOpen__rI1_8"
                            width="186"
                            height="48"
                            viewBox="0 0 189 48"
                            aria-hidden="true"
                        >
                            <path
                                d="m104.963 38.903 7.94-30.117h-2.112l-7.94 30.117h2.112ZM.995 17.113l10.6-5.491 10.713 5.49-10.714 5.51-10.6-5.51ZM64.629 19.782v-.13c0-1.812 1.065-2.39 2.86-2.26v-3.305c-4.3-.261-6.337 1.886-6.337 5.564v.131H59.21v3.305h1.943v10.009h3.477V23.087h3.999v10.009h3.476V23.087h2.86v-3.305h-2.86v-.13c0-1.812 1.047-2.39 2.86-2.26v-3.305c-4.299-.261-6.336 1.886-6.336 5.564v.131h-4Z"
                            ></path>
                            <path
                                fill-rule="evenodd"
                                d="M42.108 19.67c0 1.606-.673 2.857-1.776 3.734 1.514.86 2.486 2.334 2.523 4.258 0 3.193-2.616 5.396-5.887 5.396H28.95V14.423h7.42c3.196 0 5.738 2.129 5.738 5.247Zm-3.7.261c0-1.176-.823-2.054-2.02-2.054H32.67v4.108h3.719c1.158 0 2.018-.877 2.018-2.054Zm-5.738 9.71h4.28c1.27 0 2.186-.934 2.186-2.203 0-1.251-.916-2.185-2.187-2.185h-4.28v4.388Z"
                            ></path>
                            <path
                                d="M53.695 19.763v7.189c0 2.315-1.27 3.305-2.971 3.305-1.57 0-2.673-.934-2.673-2.745v-7.749h-3.476v8.179c0 3.547 2.224 5.508 5.102 5.508 1.813 0 3.215-.672 4-1.867v1.494h3.476V19.763h-3.458Z"
                            ></path>
                            <path
                                fill-rule="evenodd"
                                d="M79.206 27.83h10.167c.075-.448.131-.896.131-1.42 0-3.92-2.84-7.039-6.822-7.039-4.242 0-7.12 3.063-7.12 7.04s2.86 7.04 7.382 7.04c2.598 0 4.616-1.046 5.869-2.858l-2.804-1.587c-.58.766-1.663 1.326-3.028 1.326-1.812 0-3.27-.747-3.775-2.502Zm-.056-2.652c.393-1.699 1.663-2.689 3.532-2.689 1.458 0 2.916.766 3.346 2.69H79.15Z"
                            ></path>
                            <path
                                d="M94.532 22.06v-2.296h-3.477v13.313h3.477V26.71c0-2.801 2.28-3.604 4.093-3.38v-3.828c-1.701 0-3.402.747-4.093 2.558ZM4.363 28.123l7.231 3.921 7.308-3.921 3.406 1.82-10.714 5.743-10.6-5.742 3.369-1.821Z"
                            ></path>
                            <path
                                d="m4.363 21.935 7.231 3.556 7.308-3.556 3.406 1.66-10.714 5.215-10.6-5.215 3.369-1.66Z"
                            ></path>
                            <path
                                fill-rule="evenodd"
                                d="M125.392 15.075c5.148 0 9.13 3.93 9.13 9.155 0 5.224-3.982 9.156-9.155 9.156-5.149 0-9.156-3.932-9.156-9.156s4.007-9.155 9.181-9.155Zm-.025 2.003c-3.957 0-7.025 3.069-7.025 7.152s3.068 7.152 7.025 7.152c3.956 0 7.025-3.043 7.025-7.152 0-4.108-3.069-7.152-7.025-7.152ZM138.04 39.447v-20.29h2.105v2.816c1.065-1.851 2.967-3.094 5.377-3.094 3.778 0 6.517 3.018 6.517 7.253 0 4.21-2.739 7.254-6.543 7.254-2.384 0-4.286-1.243-5.351-3.095v9.156h-2.105Zm7.076-8.065c2.815 0 4.793-2.181 4.793-5.25 0-3.043-1.978-5.25-4.793-5.25-2.841 0-4.996 2.181-4.996 5.25s2.155 5.25 4.996 5.25ZM154.713 26.183c0 4.26 3.018 7.203 7.152 7.203 2.917 0 5.453-1.446 6.62-4.413h-2.182c-.836 1.623-2.434 2.434-4.362 2.434-2.815 0-4.869-1.75-5.072-4.64h11.945c.178-4.591-2.637-7.888-6.974-7.888-4.159 0-7.127 3.069-7.127 7.304Zm11.819-1.395h-9.562c.482-2.282 2.308-3.931 4.87-3.931 2.511 0 4.235 1.598 4.692 3.931Z"
                            ></path>
                            <path
                                d="M171.936 19.158h2.105v2.739c.964-1.852 2.561-3.018 4.996-3.018 3.145 0 5.047 1.978 5.047 5.376v8.852h-2.105V24.66c0-2.51-1.243-3.779-3.525-3.779-2.841 0-4.413 2.004-4.413 5.073v7.152h-2.105v-13.95Z"
                            ></path>
                        </svg>
                        <p class="text-heading open_heroHeading__kPQJW">
                            A transparent company since 2010
                        </p>
                        <p>
                            Since 2013, we’ve been open with Buffer’s finances
                            and our team’s salaries, among many other metrics.
                            We share openly because we believe in the power of
                            transparency to build trust, hold us accountable to
                            a high standard, and push our industry forward.
                        </p>
                        <p>
                            This is a dashboard for anyone to see how we’re
                            building Buffer.
                        </p>
                    </div>
                    <div class="open_openSections__LBhbE">
                        <section
                            class="OpenSection_section__KJFB7"
                            aria-labelledby="headingMonthlyMetrics"
                        >
                            <div class="OpenSection_contentContainer__jTH1Z">
                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span
                                                class="OpenSection_headingLinkIconContainer__1lWc_"
                                                aria-hidden="true"
                                            >
                                                <svg
                                                    class="OpenSection_headingLinkIcon__Wwk9o"
                                                    width="24"
                                                    height="24"
                                                    viewBox="0 0 24 24"
                                                >
                                ...
                                <div class="OpenSection_contentTrailing__23TP0">
                                    <dl class="MonthlyMetrics_metrics__g2u95">
                                        <div
                                            class="MonthlyMetrics_metric__ePzBX MonthlyMetrics_metricMAU__nPEJC"
                                        >
                                            <dt
                                                class="MonthlyMetrics_metricTerm__HBtoG"
                                            >
                                                <abbr
                                                    class="text-heading MonthlyMetrics_metricAbbreviation__Qf59t"
                                                    title="Monthly Active Users"
                                                >
                                                    MAU
                                                </abbr>
                                                <span
                                                    class="MonthlyMetrics_metricTitle__l6OFc"
                                                >
                                                    Monthly Active Users
                                                </span>
                                            </dt>
                                            <dd
                                                class="text-heading MonthlyMetrics_metricValue__oVNOF"
                                            >
                                                187,143
                                            </dd>
                                        </div>
                                        <div
                                            class="MonthlyMetrics_metric__ePzBX MonthlyMetrics_metricMRR__sV0XF"
                                        >
                                            <dt
                                                class="MonthlyMetrics_metricTerm__HBtoG"
                                            >
                                        ...
                                        <div
                                            class="MonthlyMetrics_metric__ePzBX MonthlyMetrics_metricARPU__nC7mQ"
                                        >
                                            <dt
                                                class="MonthlyMetrics_metricTerm__HBtoG"
                                            >
                                        ...
                                        <div
                                            class="MonthlyMetrics_metric__ePzBX MonthlyMetrics_metricARR__8kUaa"
                                        >
                                            <dt
                                                class="MonthlyMetrics_metricTerm__HBtoG"
                                            >
                        ...
                        <div class="open_offsetSections__aanYt">
                            <section
                                class="OpenSection_section__KJFB7"
                                aria-labelledby="headingShareholderUpdates"
                            >
                                <div
                                    class="OpenSection_contentContainer__jTH1Z"
                                >
                                    <div>
                                        <h2
                                            class="OpenSection_heading__J1D7y"
                                    ...
                                    <div
                                        class="OpenSection_contentTrailing__23TP0"
                                    >
                                        <ul
                                            class="ShareholderUpdates_list__WGLCM"
                                        >
                                            <li
                                                class="ShareholderUpdates_listItem__zI3yu"
                                            >
                                                <h3>
                                                    <a
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <svg
                                                                class="ShareholderUpdates_linkIcon__CFB_t"
                                                                width="32"
                                                                height="32"
                                                                viewBox="0 0 32 32"
                                                            >
                                                                <path
                                                                    d="M9.361 29.25H22.8c2.71 0 4.11-1.425 4.11-4.148V13.656c0-1.765-.227-2.572-1.324-3.694l-6.593-6.694c-1.071-1.084-1.954-1.336-3.542-1.336H9.361c-2.698 0-4.11 1.424-4.11 4.16v19.01c0 2.723 1.412 4.148 4.11 4.148Zm.214-2.522c-1.21 0-1.815-.63-1.815-1.79V6.243c0-1.147.605-1.79 1.828-1.79h5.345v6.858c0 1.828.895 2.71 2.71 2.71H24.4v10.917c0 1.16-.605 1.79-1.827 1.79H9.575Zm8.308-14.913c-.53 0-.756-.227-.756-.744v-6.29l6.933 7.034h-6.177Zm2.635 5.51h-9.102c-.479 0-.82.34-.82.78 0 .454.341.808.82.808h9.102a.786.786 0 0 0 .794-.807.773.773 0 0 0-.794-.782Zm0 4.21h-9.102a.792.792 0 0 0-.82.806c0 .442.341.782.82.782h9.102c.453 0 .794-.34.794-.782a.786.786 0 0 0-.794-.806Z"
                                                                ></path>
                                                            </svg>
                                                        </span>
                                                        <span
                                                            class="ShareholderUpdates_linkTrailing__8NNRp"
                                                        >
                                                            <span
                                                                class="ShareholderUpdates_linkTitle__SadAu"
                                                            >
                                                                June 2025
                                                            </span>
                                                            <span
                                                                class="ShareholderUpdates_linkCTA__8VWTw"
                                                                aria-hidden="true"
                                                            >
                                                                Read report
                                                            </span>
                            ...
                            <section
                                class="OpenSection_section__KJFB7 open_offsetSection__QVgJd"
                                aria-labelledby="headingSalaries"
                            >
                                <div
                                    class="OpenSection_contentContainer__jTH1Z"
                                >
                                    ...
                                    >
                                        <div
                                            class="TransparentSalaries_content__V3RPH"
                                        >
                                            <dl
                                                class="TransparentSalaries_highlights__bjrr7"
                                            >
                                                <div
                                                    class="TransparentSalaries_highlight__OI9qw TransparentSalaries_highlightPurple__VJNkM"
                                                >
                                                    <dt
                                                        class="TransparentSalaries_highlightTitle__KmMy2"
                                                    >
                                                        CEO Salary
                                                    </dt>
                                                    <dd
                                                        class="text-heading TransparentSalaries_highlightValue__RwuOE"
                                                    >
                                                        $301,860
                                                    </dd>
                                                </div>
                                                <div
                                                    class="TransparentSalaries_highlight__OI9qw TransparentSalaries_highlightBlue__1NDmg"
                                                >
                                                    <dt
                                                        class="TransparentSalaries_highlightTitle__KmMy2"
                                                    >
                                            ...
                                            <dl>
                                                <div
                                                    class="TransparentSalaries_employee__Vz2Ps"
                                                >
                                                    <dt
                                                        class="TransparentSalaries_employeeContentLeading__pG_wj"
                                                    >
                                                        <span
                                                            class="TransparentSalaries_employeeImage__34lyH"
                                                        >
                                                            <img
                                                                alt=""
                                                                loading="lazy"
                                                        ...
                                                        <span
                                                            class="TransparentSalaries_employeeContentLeadingText__dzpiq"
                                                        >
                                                            <span
                                                                class="TransparentSalaries_employeeName__Yqd9t"
                                                            >
                                                                Martín
                                                            </span>
                                                            <span
                                                                class="TransparentSalaries_employeeRole__oACvB"
                                                            >
                                                                Software
                                                                Engineer
                                                            </span>
                                                    ...
                                                    <dd
                                                        class="TransparentSalaries_employeeSalary__eJOvZ"
                                                    >
                                                        $163,372
                                                    </dd>
                                                </div>
                        ...
                        <section
                            ...
                            style="--_content-trailing-padding-inline: 0"
                        >
                            <div class="OpenSection_contentContainer__jTH1Z">
                                <div>
                                    <h2
                                ...
                                <div class="OpenSection_contentTrailing__23TP0">
                                    <div class="Timeline_container__xNlzD">
                                        <ul class="Timeline_list__eFuBX">
                                            <li class="Timeline_year__n4Bbl">
                                                <h3
                                                    class="Timeline_yearHeading__VG6DY"
                                                >
                                                    2010
                                                </h3>
                                                <div
                                                    class="Timeline_indicators__ochJu"
                                                    aria-hidden="true"
                                                >
                                                    <div
                                                        class="Timeline_timelineIndicator__zz2Ue"
                                                    ></div>
                                                    <div
                                                        class="Timeline_yearIndicator__P2j9f"
                                                    ></div>
                                                </div>
                                                <div
                                                    class="Timeline_yearContent__iXIyk"
                                                >
                                                    <div
                                                        class="Timeline_month__GbA0X"
                                                    >
                                                        <div
                                                            class="Timeline_monthIndicator__0dv_d"
                                                            aria-hidden="true"
                                                        ></div>
                                                        <div
                                                            class="Timeline_monthContent__ufNWx"
                                                        >
                                                            <span
                                                                class="Badge_badge__ohf_O"
                                                            ...
                                                            <p
                                                                class="Timeline_monthText__a3G2m"
                                                            >
                                                                Buffer was
                                                                created as part
                                                                of a Startup
                                                            ...
                                                            <a
                                                                ...
                                                                href="resources/blog/index.html"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <svg
                                                                        class="LinkButtonTertiary_icon__gxeYa"
                                                                        width="24"
                                                                        height="24"
                                                                        viewBox="0 0 24 24"
                                                                        aria-hidden="true"
                        ...
                        <section
                            class="OpenSection_section__KJFB7"
                            aria-labelledby="headingTimeOff"
                        >
                            <div class="OpenSection_contentContainer__jTH1Z">
                                <div>
                                    <h2
                        ...
                        <div class="open_offsetSections__aanYt">
                            <section
                                class="OpenSection_section__KJFB7 open_offsetSection__QVgJd"
                                aria-labelledby="headingCustomerExperience"
                            >
                                <div
                                    class="OpenSection_contentContainer__jTH1Z"
                                >
                                    ...
                                    >
                                        <dl
                                            class="AdvocacyMetrics_metrics__c2b6W"
                                        >
                                            <div
                                                class="AdvocacyMetrics_metric__3PGCU"
                                            >
                                                <dt>
                                                    First response within 2
                                                    hours in the last 90 days
                                                </dt>
                                                <dd
                                                    class="text-heading AdvocacyMetrics_metricValue__Rmv9T"
                                                >
                            ...
                            <section
                                class="OpenSection_section__KJFB7"
                                aria-labelledby="headingSignUps"
                            >
                                <div
                                    class="OpenSection_contentContainer__jTH1Z"
                                >
                        ...
                        >
                            <div class="OpenSection_contentContainer__jTH1Z">
                                ...
                                <div class="OpenSection_contentTrailing__23TP0">
                                    <div
                                        class="Ticker_ticker__OD_CL"
                                        data-direction="left"
                                        data-pause-on-hover="true"
                                    >
                                        <div class="Ticker_items__uM4j3">
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51DNB0VpXgL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41DbNI5k3OL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41CiJ9jpmfL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/516hpPbQhWL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51KD3bAK7GL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41AOKNyKnVL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41w+-LDt3-L._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51PbZGXYWKL._SY445_SX342_QL70_FMwebp_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            ...
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51vjDTDng8L._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51tvMjnKtcL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41A1k8e+r4L._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51up3msUDsL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41+e9r6NBYL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51Wy6Q9QU3L._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41MCibQ+o-L._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41WAmrqJojL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51p+RI3mOUL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/41xM5o088dL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51f9CYkFRPL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51HPbOKV1SL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/51baFNrzBvL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/515yrFE2YCL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                                            <div class="Books_book__r7adP">
                                                <img
                                                    class="Books_bookImage___zRZD"
                                                    src="https://m.media-amazon.com/images/I/418Jc5AERoL._SY445_SX342_.jpg"
                                                    alt=""
                                                    loading="lazy"
                                                />
                                            </div>
                            ...
                            <div class="OpenSection_contentContainer__jTH1Z">
                                ...
                                <div class="OpenSection_contentTrailing__23TP0">
                                    <div class="scroll-inline-container">
                                        <article class="open_card__svvkT">
                                            <div
                                                class="Card_card__RlVbj"
                                                data-layout="default"
                                                data-theme="light"
                                            >
                                                <div
                                                    class="Card_content__9gie_"
                                                >
                                                    <div
                                                        class="Card_contentLeading__z6Vmq"
                                                    >
                                                        <div
                                                            class="Card_imageContainer__tz8v8"
                                                        >
                                                            <img
                                                                class="Card_image__MTxJg"
                                                                src="../resources/content/images/2025/08/IMG_6319--1-.jpg"
                                                                alt=""
                                                                width="380"
                                                                height="320"
                                                                loading="lazy"
                                                    ...
                                                    <div
                                                        class="Card_contentTrailing__SYRJl"
                                                    >
                                                        <h3
                                                            class="Card_heading__KTt_J"
                                                        >
                                                            <a
                                                        ...
                                                        <div
                                                            class="Card_contentText__UoQPR"
                                                        >
                                                            <p
                                                                class="Card_text__z4JZf"
                                                            >
                                                                We’re
                                                                intentionally
                                                                investing in
                                                        ...
                                                        <div
                                                            class="Card_cta__zalFh"
                                                            aria-hidden="true"
                                                        >
                                                            <span
                                                                class="Card_ctaIconContainer__t_2du"
                                                            >
                                                                <svg
                                                                    class="Card_ctaIcon__SG6Tj"
                                                                    width="24"
                                                                    height="24"
                                                                    viewBox="0 0 24 24"
                                                                    aria-hidden="true"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <img
                                                                class="Card_image__MTxJg"
                                                                src="../resources/content/images/2025/07/learning---development-at-buffer-1.png"
                                                                alt=""
                                                                width="380"
                                                                height="320"
                                                                loading="lazy"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <img
                                                                class="Card_image__MTxJg"
                                                                src="../resources/content/images/2025/07/buffer-api.png"
                                                                alt=""
                                                                width="380"
                                                                height="320"
                                                                loading="lazy"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <img
                                                                class="Card_image__MTxJg"
                                                                src="../resources/content/images/2025/07/Retreat-Planning-Playbook-Draft.jpg"
                                                                alt=""
                                                                width="380"
                                                                height="320"
                                                                loading="lazy"
            ...
            <div id="modal-root" class="jsx-1876722636"></div>
            <div
                style="background-color: var(--color-neutral-050)"
                class="jsx-1876722636"
            >
                <footer class="Footer_footer__4vzqH">
                    ...
                    <div class="Footer_trailingContent__Ug_0q">
                        ...
                        <div class="Footer_bottomLinks__AMVW0">
                            <div class="Footer_socialLinks__22g9N">
                                <h3 class="visually-hidden">Social media</h3>
                                <ul class="Footer_socialLinkList__YR3Qy">
                                    <li>
                                        <a
                                            href="https://www.instagram.com/buffer"
                                            rel="noopener noreferrer"
                                        >
                                            <span class="visually-hidden">
                                                Instagram
                                            ...
                                            <svg
                                                class="Footer_socialLinkLogo__Bqkq_"
                                                width="32"
                                                height="32"
                                                viewBox="0 0 32 32"
                                                aria-hidden="true"
                                            >
                                                ...
                                                ></path>
                                                <path
                                                    d="M25.471 8.614a1.7 1.7 0 1 1-3.4 0 1.7 1.7 0 0 1 3.4 0Z"
                                                ></path>
                                                <path
                                                    fill-rule="evenodd"
                                    ...
                                    <li>
                                        ...
                                        >
                                            ...
                                            >
                                                <path
                                                    d="M31.33 16.755C31.33 8.605 24.765 2 16.666 2 8.565 2 2 8.606 2 16.755c0 7.364 5.363 13.468 12.374 14.575V21.02H10.65v-4.265h3.724v-3.25c0-3.699 2.19-5.741 5.54-5.741 1.604 0 3.282.288 3.282.288v3.63h-1.85c-1.821 0-2.39 1.138-2.39 2.305v2.768h4.068l-.65 4.265h-3.417v10.31c7.01-1.107 12.373-7.21 12.373-14.575Z"
                                                ></path>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="https://bsky.app/profile/buffer.com"
                                        >
                                            <span class="visually-hidden">
                                                Bluesky
                                            </span>
                                            ...
                                            >
                                                <path
                                                    d="M7.692 5.615c3.363 2.347 6.98 7.104 8.308 9.656 1.328-2.552 4.945-7.31 8.308-9.656 2.427-1.692 6.359-3.002 6.359 1.166 0 .832-.514 6.992-.815 7.993-1.047 3.476-4.863 4.363-8.257 3.827 5.933.938 7.442 4.046 4.183 7.153-6.19 5.902-8.897-1.48-9.59-3.372-.128-.347-.187-.51-.188-.372 0-.138-.06.025-.188.372-.693 1.891-3.4 9.274-9.59 3.372-3.259-3.108-1.75-6.215 4.183-7.154-3.394.537-7.21-.35-8.257-3.827-.301-1-.815-7.16-.815-7.992 0-4.168 3.932-2.858 6.359-1.166Z"
                                                ></path>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        ...
                                        >
                                            ...
                                            >
                                                <path
                                                    d="M23.573 5.075h3.912l-8.546 9.768 10.054 13.291H21.12l-6.165-8.06-7.055 8.06H3.987l9.14-10.447L3.483 5.075h8.072l5.573 7.369 6.445-7.369Zm-1.372 20.718h2.167l-13.991-18.5H8.05l14.15 18.5Z"
                                                ></path>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        ...
                                        >
                                            ...
                                            >
                                                <path
                                                    d="M26.627 26.113h-4.182v-6.562c0-1.562 0-3.583-2.185-3.583s-2.53 1.708-2.53 3.469v6.676h-4.182v-13.54h4.036v1.843h.063a4.415 4.415 0 0 1 1.69-1.637 4.435 4.435 0 0 1 2.293-.54c4.265 0 5.05 2.792 5.05 6.437l-.053 7.438ZM8.74 10.77a2.452 2.452 0 0 1-2.26-1.504 2.43 2.43 0 0 1 .53-2.657 2.45 2.45 0 0 1 2.666-.528 2.444 2.444 0 0 1 1.51 2.252c0 .646-.257 1.266-.716 1.723a2.451 2.451 0 0 1-1.73.714Zm2.091 15.343H6.648v-13.54h4.182v13.54ZM4.526 2c-.554 0-1.086.22-1.478.61a2.08 2.08 0 0 0-.613 1.473v24.218c0 .553.22 1.082.613 1.473.392.39.924.61 1.478.61H28.73c.554 0 1.086-.22 1.478-.61.392-.39.612-.92.612-1.473V4.041a2.08 2.08 0 0 0-.627-1.446A2.095 2.095 0 0 0 28.73 2H4.526Z"
                                                ></path>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="https://www.threads.net/@buffer"
                                            rel="noopener noreferrer"
                                        >
                                            <span class="visually-hidden">
                                                Threads
                            ...
                            <div>
                                ...
                                <div class="Footer_policies__h_I0e">
                                    <p>
                                        Copyright ©
                                        <!-- -->
                                        2025
                    ...
                    <div class="Footer_divider__07lwa" aria-hidden="true"></div>
                </footer>
            </div>
        </div>
    </div>
    ...
    <div
        role="dialog"
        id="radix-:R7pf6:"
        aria-describedby="radix-:R7pf6H2:"
        aria-labelledby="radix-:R7pf6H1:"
        data-state="open"
        class="Nav_menuContentPanel__R3KkS"
        tabindex="-1"
        style="pointer-events: auto"
    >
        <h2 id="radix-:R7pf6H1:" class="visually-hidden">Navigation menu</h2>
        <div class="Nav_menuContentLeading__8I7_1">
            <a class="Nav_logoLink__xSVf_" href="/"
                ><svg
                    class="BufferLogo_logo__ZlBPi Nav_logo__zClE7"
                    width="132"
                ...
                >
                    ...
                    ></path></svg></a
            ><button
                class="ButtonLineIcon_button__3djaa Nav_menuClose__YW9vB"
                type="button"
                @click="menuOpen('none')"
            >
                ...
                >
                    <path
                        d="M16.62 7.317 7.316 16.62m0-9.302 9.302 9.302"
                    ></path>
                </svg>
            </button>
        </div>
        <div class="Nav_menuContent__ujZ8C">
            <details class="Details_details___T7cb">
                <summary class="Details_summary__qBPqX">
                    <div class="text-heading Details_summaryContent__gLcSg">
                        Features<svg
                            class="Details_summaryIcon__wNmIp"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            aria-hidden="true"
                ...
                <div class="Details_content__awA0g">
                    <ul class="Nav_menuContentList__FaB0t">
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                class="Nav_menuItemLink__vkTf0"
                                href="/create?cta=bufferSite-globalNav-tools-create-1"
                                ><svg
                                ...
                                >
                                    <path
                                        d="M9.643 13.519H5.767a.775.775 0 0 0-.775.775v3.876c0 .428.347.775.775.775h3.876a.775.775 0 0 0 .775-.775v-3.876a.775.775 0 0 0-.775-.775ZM9.643 4.992H5.767a.775.775 0 0 0-.775.775v3.876c0 .428.347.775.775.775h3.876a.775.775 0 0 0 .775-.775V5.767a.775.775 0 0 0-.775-.775ZM18.17 13.519h-3.876a.775.775 0 0 0-.775.775v3.876c0 .428.347.775.775.775h3.876a.775.775 0 0 0 .775-.775v-3.876a.775.775 0 0 0-.775-.775ZM15.656 4.804l-2.349 2.35c-.26.259-.26.68 0 .939l2.35 2.349c.259.26.68.26.939 0l2.349-2.35c.26-.259.26-.68 0-.939l-2.35-2.349a.664.664 0 0 0-.939 0Z"
                                    ></path></svg
                                ><span class="Nav_menuItemText__B1O7e"
                                    ><span
                                        class="Nav_menuItemTextLeading__bdmiY"
                                        ><span
                                            class="text-heading Nav_menuItemTitle__gsQC9"
                        ...
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                ...
                                ><span class="Nav_menuItemText__B1O7e"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Plan and schedule your content across
                        ...
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                ...
                                ><span class="Nav_menuItemText__B1O7e"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Measure performance and turn insights
                                        into growth</span
                                    ></span
                                ></a
                            >
                        ...
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                ...
                                ><span class="Nav_menuItemText__B1O7e"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Easily engage with your community</span
                                    ></span
                                ></a
                            >
                        </li>
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                ...
                                ><span class="Nav_menuItemText__B1O7e"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Work together seamlessly, from planning
                                        to publishing</span
                                    ></span
                                ></a
                            >
                        ...
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                ...
                                ><span class="Nav_menuItemText__B1O7e"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Build a custom link-in-bio page in
                                        minutes</span
                                    ></span
                                ></a
                            >
                            ...
                            <a
                                ...
                                >
                                    <path
                                        ...
                                        d="M5.769 4.212C8.29 5.972 11.004 9.539 12 11.453c.996-1.914 3.709-5.482 6.231-7.241C20.051 2.942 23 1.96 23 5.086c0 .624-.385 5.244-.611 5.994-.785 2.608-3.647 3.273-6.192 2.87 4.449.704 5.58 3.035 3.136 5.366-4.642 4.426-6.672-1.111-7.192-2.53-.096-.26-.14-.382-.141-.278 0-.104-.045.018-.14.278-.52 1.419-2.55 6.956-7.193 2.53-2.445-2.331-1.313-4.662 3.136-5.366-2.545.403-5.407-.262-6.192-2.87C1.385 10.33 1 5.71 1 5.086c0-3.126 2.949-2.144 4.769-.874Z"
                                    ></path></svg
                                ><span class="Nav_channelLinkText__X3PBu"
                                    ><span>Bluesky</span
                                    ><svg
                                        class="Nav_channelLinkIcon__YZ86q"
                                        width="24"
            ...
            <details class="Details_details___T7cb">
                ...
                <div class="Details_content__awA0g">
                    <ul class="Nav_menuContentList__FaB0t">
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a class="Nav_menuItemLink__vkTf0" href="/resources"
                                ><span class="Nav_menuItemText__B1O7e"
                                    ><span
                                        class="Nav_menuItemTextLeading__bdmiY"
                                        ><span
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Real-life stories and resources on
                                        growing an engaged audience</span
                                    ></span
                                ></a
                            >
                        </li>
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a class="Nav_menuItemLink__vkTf0" href="/templates"
                                ><span class="Nav_menuItemText__B1O7e"
                                    ><span
                                        class="Nav_menuItemTextLeading__bdmiY"
                                        ><span
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Plug-and-play content templates to
                                        jump-start your planning</span
                                    ></span
                                ></a
                            >
                        </li>
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                ...
                                ><span class="Nav_menuItemText__B1O7e"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Easy-to-use tools to grow your presence
                        ...
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a class="Nav_menuItemLink__vkTf0" href="/insights"
                                ><span class="Nav_menuItemText__B1O7e"
                                    ><span
                                        class="Nav_menuItemTextLeading__bdmiY"
                                        ><span
                                            class="text-heading Nav_menuItemTitle__gsQC9"
                                            >Social Media Insights</span
                                        ><svg
                                            class="Nav_menuItemIcon__fw__X"
                                            width="24"
                                            height="24"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Data-driven benchmarks, trends, and
                                        tips to grow smarter on social</span
                                    ></span
                                ></a
                            >
                        </li>
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a class="Nav_menuItemLink__vkTf0" href="/community"
                                ><span class="Nav_menuItemText__B1O7e"
                                    ><span
                                        class="Nav_menuItemTextLeading__bdmiY"
                                        ><span
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Learn, connect, and grow with creators
                        ...
                        <li class="Nav_menuContentListItem__GRXp0">
                            <a
                                ...
                                ><span class="Nav_menuItemText__B1O7e"
                                    ...
                                    ><span
                                        class="Nav_menuItemDescription___2r1C"
                                        >Help articles and tutorials to get the
                                        most out of Buffer</span
                                    ></span
                                ></a
                            >
                        </li>
            ...
            <a
                class="Nav_navLink___7VKG Nav_menuNavLink__aJ5jU"
                href="/pricing?cta=bufferSite-globalNav-pricing-pricing-1"
            >
                Pricing
            </a>
...
const menuOpen = (open: string = 'block') => {
...
const data = [
    5, 20, 36, 10, 10, 20, 36, 10, 10, 20, 36, 10, 10, 20, 36, 10, 10, 20, 36,
    10, 10, 20, 36, 10, 10, 20, 36,
]
...
onMounted(() => {
    ...
    // time off chart
    const myChart2 = echarts.init(timeoffChart.value)
    myChart2.setOption(timeoffDatas.value)
    // signups
    const myChart3 = echarts.init(signupsChart.value)
    myChart3.setOption(signupsDatas.value)
})
</script>
...
@font-face {
    ...
    font-style: normal;
    font-weight: 300 900;
    src: url('static/fonts/figtree/figtree-variable.ttf') format('truetype');
}
@font-face {
    font-display: fallback;
    font-family: 'Figtree';
    font-style: italic;
    font-weight: 300 900;
    src: url('static/fonts/figtree/figtree-variable-italic.ttf')
        format('truetype');
}
@font-face {
    font-display: fallback;
    ...
    font-style: normal;
    font-weight: 100 900;
    src: url('static/fonts/inter/inter-variable.ttf') format('truetype');
}
@font-face {
    font-display: fallback;
    font-family: 'Inter';
    font-style: italic;
    font-weight: 100 900;
    src: url('static/fonts/inter/inter-variable-italic.ttf') format('truetype');
}
@font-face {
    font-display: fallback;
    font-family: 'Stolzl';
    font-style: normal;
    font-weight: 400;
    src: url('static/fonts/stolzl/stolzl-regular.woff2') format('woff2');
}
:root {
    --color-white: hsl(0 0% 100%);
    --color-neutral-050: hsl(60 75% 99%);
...
h6 {
    ...
    font-weight: var(--font-weight-heading);
    line-height: var(--line-height-heading);
    -webkit-letter-spacing: var(--letter-spacing-heading);
    -moz-letter-spacing: var(--letter-spacing-heading);
    -ms-letter-spacing: var(--letter-spacing-heading);
    letter-spacing: var(--letter-spacing-heading);
}
a {
    color: inherit;
...
[data-theme='dark'] a:not([class]):focus-visible {
...
:target {
    -webkit-scroll-margin-block: 5ex;
    -moz-scroll-margin-block: 5ex;
    -ms-scroll-margin-block: 5ex;
...
.text-eyebrow {
    ...
    -webkit-letter-spacing: var(--letter-spacing-wide);
    -moz-letter-spacing: var(--letter-spacing-wide);
    -ms-letter-spacing: var(--letter-spacing-wide);
...
.text-input {
    ...
    border: 0.0625rem solid var(--color-neutral-700);
...
.container {
    ...
    padding-block-end: var(--space-step-8);
}
...
.max-inline-size-container-wide {
    margin-inline: auto;
    max-inline-size: var(--container-max-inline-size-wide);
    padding-inline: var(--space-step-3-step-5);
}
.sidebar-layout {
    display: -webkit-box;
...
.scroll-inline-container {
    margin-inline: auto;
    inline-size: 100%;
    max-inline-size: calc(80rem + 2.5rem * 2);
    padding: var(--space-step-3) 0.25rem;
    display: -webkit-box;
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
...
.scroll-inline-container::before,
.scroll-inline-container::after {
    content: '';
    display: inline-block;
    inline-size: 0.25rem;
}
@media (min-width: 64rem) {
    .scroll-inline-container-centered {
...
[id] {
    -webkit-scroll-margin-block-start: 6rem;
    -moz-scroll-margin-block-start: 6rem;
    -ms-scroll-margin-block-start: 6rem;
...
.select {
    ...
    padding-inline: var(--space-step-2) var(--space-step-5);
    display: -webkit-box;
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
    ...
    justify-content: space-between;
    -webkit-column-gap: var(--space-step-3);
    column-gap: var(--space-step-3);
    font-size: var(--font-size-step--1);
    cursor: pointer;
    outline-width: var(--outline-width);
    outline-color: transparent;
